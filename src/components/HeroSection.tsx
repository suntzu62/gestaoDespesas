...
import { Play, CheckCircle, TrendingUp, Users, Award, ArrowRight } from 'lucide-react';
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            {/* Trust Badge */}
            <div className="inline-flex items-center gap-2 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-semibold mb-8 animate-pulse">
              <Award className="w-4 h-4" />
              Melhor App Financeiro 2024 - Valor Econômico
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Centralize salários, gastos, metas e previsões de fluxo de caixa. A gestão 
              financeira inteligente que o Brasil precisa.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <span>Orçamento base zero em português</span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0" />
                <span>IA treinada para gastos brasileiros</span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <a href="/signup" className="group bg-green-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-green-700 transition-all duration-300 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:scale-105">
                Comece Grátis
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <button className="group border-2 border-green-600 text-green-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-green-600 hover:text-white transition-all duration-300 flex items-center justify-center gap-3">
          ...
          <div className="relative">
            ...
            <div className="relative mx-auto max-w-sm">
              <div className="bg-gray-900 rounded-3xl p-2 shadow-2xl transform rotate-6 hover:rotate-3 transition-transform duration-300">
                <div className="bg-white rounded-2xl overflow-hidden">
                  ...
                  {/* App Content */}
                  <div className="p-6 bg-gradient-to-br from-green-50 to-blue-50 min-h-96">
                    {/* Header */}
            ...
            <div className="absolute -bottom-6 -left-6 bg-green-600 text-white rounded-lg shadow-lg p-3">
      ...
      <div className="absolute bottom-0 left-0 w-full">
        <svg className="w-full h-20 fill-current text-white" viewBox="0 0 1440 120" xmlns="http://www.w3.org/2000/svg">
