        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div
              ...
              role="img"
              aria-label="Screenshot do aplicativo BolsoZen"
            >
              <div className="bg-gray-900 rounded-3xl p-2 shadow-2xl transform rotate-6 hover:rotate-3 transition-transform duration-300">
                <div className="bg-white rounded-2xl overflow-hidden">
                  ...
                  {/* App Content */}
                  <div
                    className="p-6 bg-gradient-to-br from-green-50 to-blue-50 min-h-96"
            ...
            {/* Floating Elements */}
            <div
              className="absolute -top-6 -right-6 bg-white rounded-lg shadow-lg p-3 animate-bounce"
            ...
            <div
              className="absolute -bottom-6 -left-6 bg-green-600 text-white rounded-lg shadow-lg p-3"
